...
const navItems: NavItem[] = [
  ...
  { to: '/calendar', label: 'Calendario de equipo', icon: CalendarDays },
  { to: '/requests', label: 'Mis solicitudes', icon: CalendarCheck },
  { to: '/approvals', label: 'Aprobaciones', icon: ClipboardCheck, adminOnly: true },
  { to: '/employees', label: 'Empleados', icon: Users, adminOnly: true },
  { to: '/departments', label: 'Sectores', icon: Building2, adminOnly: true },
  { to: '/holidays', label: 'Feriados', icon: PartyPopper, adminOnly: true },
